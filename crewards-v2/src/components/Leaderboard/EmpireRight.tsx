  ...
  return (
    ...
    >
      ...
      <img
        src="/right.png"
        alt="Mini Right 1"
        className="absolute 2xl:top-0 lg:top-0 right-0 2xl:w-[27rem] lg:w-[20rem] h-[100vh] top-1/5 z-5 lg:opacity-100 opacity-40" // Assegura que esta imagem fique acima do fundo
      />
      {/* <img
        src="/knife.png"
        alt="Mini Right 2"  
