...
const Empire: React.FC = () => {
  ...
  return (
    <div className="relative items-center justify-center min-h-screen bg-cover bg-center bg-[#0E0E0E]">
      {/* Primeira View */}
      <div className="relative flex flex-wrap items-center justify-center lg:min-h-[100vh] custom-min-h-1 bg-cover bg-center">
        ...
        <div className="absolute vip-second-view-b z-10 md:w-[68%] w-[80%] bottom-[2vw]">
          ...
          <div className="bg-[#191919] rounded-xl md:p-8 p-2 z-10 mt-[1vw] text-white text-center flex justify-between items-center">
            ...
            <div className="flex items-center">
              {/* Available */}
              <div className="flex justify-between items-center bg-[#131313] md:p-4 p-2 rounded-xl border-[#2a2a2a] border-2 mr-2 pr-6">
                ...
                <img
                  src="/icons/coins.png"
                  alt="Coins"
                  className="md:w-4 md:h-4 w-[3vw] object-contain mr-2"
                />
                <p className="font-bold md:text-[1vw] text-[2.4vw]">0</p>
              </div>
              {/* Redeem Reward */}
              {isLoggedIn ? (
                <div className="flex cursor-pointer justify-center md:p-4 shadow-button items-center text-center bg-gradient-to-l from-[#9C6E0A] to-[#F6AF16] rounded-xl hover:opacity-70 transition-opacity duration-300">
                  ...
                  />
                  <p className="font-bold font-workSans text-base text-white md:text-[1vw] text-[12px]">
                    REDEEM REWARD
                  </p>
                </div>
              ) : (
                <div className="flex cursor-not-allowed justify-center md:p-4 shadow-button items-center text-center bg-gradient-to-l from-[#9C6E0A] to-[#F6AF16] rounded-xl opacity-20">
                  <img
                    src="/icons/gift-1-1.png"
                    alt="Imagem do botão"
                    className="w-5 h-5 object-contain mr-2"
              ...
              <div className="flex items-center">
                ...
                <div className="flex justify-between items-center bg-[#131313] md:p-4 p-2 rounded-xl border-[#2a2a2a] border-2 mr-2 pr-6">
                  ...
                  <img
                    src="/icons/coins.png"
                    alt="Coins"
                    className="md:w-4 md:h-4 w-[2.4vw] object-contain mr-2"
                  />
